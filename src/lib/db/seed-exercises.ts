...
const list: SeedExercise[] = [
  ...
  { name: "Incline Barbell Bench Press", primaryMuscle: "chest", secondaryMuscles: ["shoulders", "triceps"], equipment: "barbell", standardLift: null },
  { name: "Dumbbell Bench Press", primaryMuscle: "chest", secondaryMuscles: ["triceps", "shoulders"], equipment: "dumbbell", standardLift: null },
  { name: "Incline Dumbbell Press", primaryMuscle: "chest", secondaryMuscles: ["shoulders", "triceps"], equipment: "dumbbell", standardLift: null },
  ...
  { name: "Machine Chest Press", primaryMuscle: "chest", secondaryMuscles: ["triceps"], equipment: "machine", standardLift: null },

  // Back
  { name: "Deadlift", primaryMuscle: "back", secondaryMuscles: ["hamstrings", "glutes", "traps"], equipment: "barbell", standardLift: "deadlift" },
  { name: "Sumo Deadlift", primaryMuscle: "back", secondaryMuscles: ["glutes", "hamstrings"], equipment: "barbell", standardLift: null },
  { name: "Romanian Deadlift", primaryMuscle: "hamstrings", secondaryMuscles: ["glutes", "back"], equipment: "barbell", standardLift: null },
  ...
  { name: "Barbell Row", primaryMuscle: "back", secondaryMuscles: ["biceps", "traps"], equipment: "barbell", standardLift: null },
  { name: "Pendlay Row", primaryMuscle: "back", secondaryMuscles: ["biceps"], equipment: "barbell", standardLift: null },
  ...
  { name: "Rack Pull", primaryMuscle: "back", secondaryMuscles: ["traps", "hamstrings"], equipment: "barbell", standardLift: null },
  ...
  { name: "Seated Dumbbell Press", primaryMuscle: "shoulders", secondaryMuscles: ["triceps"], equipment: "dumbbell", standardLift: null },
  { name: "Arnold Press", primaryMuscle: "shoulders", secondaryMuscles: ["triceps"], equipment: "dumbbell", standardLift: null },
  ...
  { name: "Close-Grip Bench Press", primaryMuscle: "triceps", secondaryMuscles: ["chest"], equipment: "barbell", standardLift: null },
  ...
  { name: "Front Squat", primaryMuscle: "quads", secondaryMuscles: ["glutes", "core"], equipment: "barbell", standardLift: null },
  { name: "Goblet Squat", primaryMuscle: "quads", secondaryMuscles: ["glutes"], equipment: "dumbbell", standardLift: null },
  { name: "Leg Press", primaryMuscle: "quads", secondaryMuscles: ["glutes"], equipment: "machine", standardLift: null },
  { name: "Bulgarian Split Squat", primaryMuscle: "quads", secondaryMuscles: ["glutes"], equipment: "dumbbell", standardLift: null },
  { name: "Walking Lunge", primaryMuscle: "quads", secondaryMuscles: ["glutes"], equipment: "dumbbell", standardLift: null },
  ...
  { name: "Hip Thrust", primaryMuscle: "glutes", secondaryMuscles: ["hamstrings"], equipment: "barbell", standardLift: null },
  ...
  // Full body / Olympic
  { name: "Power Clean", primaryMuscle: "full-body", secondaryMuscles: ["back", "quads", "traps"], equipment: "barbell", standardLift: null },
  ...
  { name: "Thruster", primaryMuscle: "full-body", secondaryMuscles: ["shoulders", "quads"], equipment: "barbell", standardLift: null },
